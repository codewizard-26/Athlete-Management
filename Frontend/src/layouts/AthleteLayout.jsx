                        ...
                        {!collapsed && (
                            <div className="flex items-center space-x-2.5">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[9px] uppercase tracking-widest text-brand-primary font-medium -mt-1">ATHLETE</span>
                                </div>
                            </div>
                        )}
                        {collapsed && (
                        ...
                        {!collapsed && (
                            <div className="flex items-center space-x-2.5 px-2 py-1.5">
                                ...
                                <div className="min-w-0 flex-grow">
                                    <p className="text-xs font-semibold text-text-primary truncate">{user?.name || "Athlete"}</p>
                    ...
                    <div className="flex-grow overflow-y-auto bg-transparent">
                        {loading ? (
                            <div className="min-h-[60vh] flex flex-col items-center justify-center">
                                <Spin size="middle" />
                                <p className="text-xs text-text-secondary mt-3 tracking-wider">Syncing dashboard...</p>
                            </div>
                        ) : (
